    ...
    public final class AppKitBackend: AppBackend {
        ...
        nonisolated public func runMainLoop(_ callback: @escaping () -> Void) {
            callback()
            Task {
                await MainActor.run {
        ...
        public func setSelectedItem(ofSelectableListView listView: Widget, toItemAt index: Int?) {
            ...
            listView.selectRowIndexes(
                IndexSet([index].compactMap { $0 }), byExtendingSelection: false)
        }
    ...
    nonisolated final class NSCustomMenuItem: NSMenuItem {
