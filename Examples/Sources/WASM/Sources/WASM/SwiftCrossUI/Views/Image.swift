...
public struct Image: Sendable {
  ...
  enum Source: Equatable {
    case url(String, useFileExtension: Bool)
  ...
  public init(_ url: String, useFileExtension: Bool = true) {
...
extension Image: TypeSafeView {
  ...
  func update<Backend: AppBackend>(
    ...
    return ViewUpdateResult.leafView(size: ViewSize(fixedSize: SIMD2(100, 100)))
  }
}
