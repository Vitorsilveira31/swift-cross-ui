...
public protocol AppBackend: Sendable {
  ...
  /// run loop starts.
  nonisolated func runMainLoop(
    _ callback: @MainActor @escaping () -> Void
  )
  ...
  nonisolated func runInMainThread(action: @MainActor @escaping () -> Void)
...
extension AppBackend {
  ...
  public func runMainLoop(_ callback: @MainActor @Sendable @escaping () -> Void) {}

  public func runInMainThread(action: @MainActor @Sendable @escaping () -> Void) {}
}
